...
/*  31 */     if (livinghurtevent != null && livinghurtevent.getEntity() != null) {
/*  32 */       execute((Event)livinghurtevent, (LevelAccessor)livinghurtevent.getEntity().m_9236_(), livinghurtevent.getEntity().m_20185_(), livinghurtevent.getEntity().m_20186_(), livinghurtevent.getEntity().m_20189_(), (Entity)livinghurtevent.getEntity());
/*     */     }
/*     */   }
/*     */ 
/*     */   
/*     */   public static void execute(LevelAccessor levelaccessor, double d0, double d1, double d2, Entity entity) {
/*  38 */     execute((Event)null, levelaccessor, d0, d1, d2, entity);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   private static void execute(@Nullable Event event, final LevelAccessor levelaccessor, final double d0, final double d1, final double d2, final Entity entity) {
/*  44 */     ServerLevel serverlevel = (ServerLevel)levelaccessor;
/*     */     
/*  46 */     if (entity != null && ForgeRegistries.ENTITY_TYPES.getKey(entity.m_6095_()).toString().equals("minecraft:villager") && levelaccessor instanceof ServerLevel && serverlevel.m_8843_(new BlockPos((int)d0, (int)d1, (int)d2)) && Math.random() <= 0.2D) {
/*  47 */       if (!levelaccessor.m_5776_() && levelaccessor.m_7654_() != null) {
/*  48 */         levelaccessor.m_7654_().m_6846_().m_240416_((Component)Component.m_237113_("<" + Component.m_237115_("entity.minecraft.villager").getString() + "> Help !"), false);
/*     */       }
/*     */       
/*  51 */       new DelayedTask(11) {
...
/* Location:              C:\Users\Aours\AppData\Roaming\PrismLauncher\instances\1.20.1 remake\minecraft\mods\AnnoyingVillagers-1.20.1-1.4.5.jar!\com\pla\annoyingvillagers\event\VillagersAssistanceEvent.class
