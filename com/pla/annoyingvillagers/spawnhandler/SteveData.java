...
/* 20 */     return (SteveData)serverLevel.m_8895_().m_164861_(SteveData::load, SteveData::new, "av_singleton_steve");
/*    */   }
/*    */   
/*    */   public static SteveData load(CompoundTag compoundTag) {
/* 24 */     SteveData bluedemonData = new SteveData();
...
/* 50 */       if ((entity instanceof com.pla.annoyingvillagers.entity.SteveEntity || entity instanceof com.pla.annoyingvillagers.entity.AngrySteveEntity) && entity.m_6084_()) {
/* 51 */         return true;
/*    */       }
...
/* Location:              C:\Users\Aours\AppData\Roaming\PrismLauncher\instances\1.20.1 remake\minecraft\mods\AnnoyingVillagers-1.20.1-1.4.5.jar!\com\pla\annoyingvillagers\spawnhandler\SteveData.class
