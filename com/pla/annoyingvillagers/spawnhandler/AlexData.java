...
/* 20 */     return (AlexData)serverLevel.m_8895_().m_164861_(AlexData::load, AlexData::new, "av_singleton_alex");
/*    */   }
/*    */   
/*    */   public static AlexData load(CompoundTag compoundTag) {
/* 24 */     AlexData alexData = new AlexData();
/* 25 */     if (compoundTag.m_128403_("activeId")) {
/* 26 */       alexData.activeId = compoundTag.m_128342_("activeId");
/*    */     }
/* 28 */     if (compoundTag.m_128425_("claimTick", 4)) {
/* 29 */       alexData.claimTick = compoundTag.m_128454_("claimTick");
/*    */     }
/* 31 */     return alexData;
/*    */   }
/*    */   
...
/* 50 */       if (entity instanceof com.pla.annoyingvillagers.entity.AlexEntity && entity.m_6084_()) {
/* 51 */         return true;
/*    */       }
...
/* Location:              C:\Users\Aours\AppData\Roaming\PrismLauncher\instances\1.20.1 remake\minecraft\mods\AnnoyingVillagers-1.20.1-1.4.5.jar!\com\pla\annoyingvillagers\spawnhandler\AlexData.class
